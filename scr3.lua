...
--[[ fuck off and upload already you nigger
...
local Succ,Err = pcall(function()
	...
	--ocal fetchJson = loadstring(game:HttpGet('https://raw.githubusercontent.com/ProgressionSessions/okchat/refs/heads/main/dependencies/load_json.lua'))() -- need rewrite cause rbx patch

	local developer_database = {} --fetchJson("https://github.com/ProgressionSessions/okchat/blob/main/json/developers.json") TEMPORARY!
